...
def main():
    ...
    while True:
        ...
        if action == "updates":
            ...
            print("Python OS 4.11 Updates")
            print("\nUpdates:")
            print("1. Added a text editor")
            print("2. Added a computer monitor")
            print("3. Bug fixes")
            print("4. added restart and exit conformation")
            print("5. Added message box errors")
            print("\nBUGS:")
